    ...
    const users = await Promise.all([
        prisma.user.create({
            data: {
                id: 'user1',
                name: 'สมชาย วิทยากร',
                email: 'somchai@devteam.com',
                password: defaultPassword,
                avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150',
                role: 'admin',
                status: 'online',
                currentTask: 'ออกแบบระบบ Authentication',
        ...
        prisma.user.create({
            data: {
                id: 'user2',
                name: 'สุภาพร ดีไซน์',
                email: 'supaporn@devteam.com',
                password: defaultPassword,
                avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150',
                role: 'designer',
                status: 'online',
                currentTask: 'ออกแบบ UI หน้า Dashboard',
                department: 'Design'
            }
        }),
        prisma.user.create({
            data: {
                id: 'user3',
                name: 'วิชัย โค้ดดิ้ง',
                email: 'wichai@devteam.com',
                password: defaultPassword,
                avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150',
                role: 'developer',
                status: 'busy',
                currentTask: 'พัฒนา API สำหรับรายงาน',
                department: 'Engineering'
            }
        }),
        prisma.user.create({
            data: {
                id: 'user4',
                name: 'นภา ทดสอบ',
                email: 'napa@devteam.com',
                password: defaultPassword,
                avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150',
                role: 'tester',
                status: 'online',
                currentTask: 'ทดสอบระบบจัดการงาน',
                department: 'QA'
            }
        }),
        prisma.user.create({
            data: {
                id: 'user5',
                name: 'ปริญญา ผู้จัดการ',
                email: 'parinya@devteam.com',
                password: defaultPassword,
                avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150',
                role: 'manager',
                status: 'away',
                currentTask: 'ประชุมทีม Sprint Planning',
